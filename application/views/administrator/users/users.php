                     ...
                     <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <?php $role = ($post['role_id'] == '4') ? 'User' : (($post['role_id'] == '1') ? 'Admin' : (($post['role_id'] == '2') ? 'Owner' : (($post['role_id'] == '3') ? 'Dokter / Pegawai' : '-')));  ?>

                                 <td><a><?php echo $role; ?></a></td>
                                 ...
                                 <td>
                                     ...
                                     <a class="label label-inverse-primary enable"
                                         href='<?php echo base_url(); ?>administrator/users/enable/<?php echo $post['id']; ?>?table=<?php echo base64_encode('users'); ?>'>Enabled</a>
                                     <?php } else { ?>
                                     <a class="label label-inverse-warning desable"
                                         href='<?php echo base_url(); ?>administrator/users/disable/<?php echo $post['id']; ?>?table=<?php echo base64_encode('users'); ?>'>Disabled</a>
                                     <?php } ?>
                                     ...
                                     <a class="label label-inverse-danger delete"
                                         href='<?php echo base_url(); ?>administrator/users/delete/<?php echo $post['id']; ?>?table=<?php echo base64_encode('users'); ?>'>Delete</a>
