...
<div class="main-menu">
    ...
    <div class="main-menu-content">
        <ul class="main-navigation">
            <?php $classNameHome = $css == 'home' ? 'nav-item has-class' : 'nav-item'; ?>

            <li class="<?php echo $classNameHome ?>">
            ...
            <li class="nav-item">
                ...
                <ul class="tree-1">
                    ...
                    <li class="nav-sub-item"><a href="#">Category</a>
                        <ul class="tree-2">
                            <li><a href="<?php echo base_url(); ?>administrator/product-categories/create">Add
                                    Category</a></li>
                            <li><a href="<?php echo base_url(); ?>administrator/product-categories">List Category</a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class="nav-item">
                ...
                <ul class="tree-1">
                    <li class="nav-sub-item"><a href="#">FAQ Category</a>
                        <ul class="tree-2">
                            <li><a href="<?php echo base_url(); ?>administrator/faq-categories/create">Add FAQ
                                    Category</a></li>
                            <li><a href="<?php echo base_url(); ?>administrator/faq-categories">List FAQ Category </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class="nav-item">
                ...
                <ul class="tree-1">
                    <li><a href="<?php echo base_url(); ?>administrator/site-configuration/update/1">Site
                            Configuration</a></li>
            ...
            <li class="nav-item">
                ...
                <ul class="tree-1">
                    <li><a href="<?php echo base_url(); ?>administrator/sliders/create"
                            data-i18n="nav.basic-components.alert">Add slider</a></li>
                    <li><a href="<?php echo base_url(); ?>administrator/sliders"
                            data-i18n="nav.basic-components.breadcrumbs">List slider</a></li>
                </ul>
            </li>
            <li class="nav-item">
                <a href="#!">
                ...
                <ul class="tree-1">
                    <li><a href="<?php echo base_url(); ?>administrator/galleries/add"
                            data-i18n="nav.basic-components.alert">Add Gallery</a></li>
                    <li><a href="<?php echo base_url(); ?>administrator/galleries"
                            data-i18n="nav.basic-components.breadcrumbs">List Gallery</a></li>
                </ul>
            </li>
            <li class="nav-item">
                <a href="#!">
                ...
                <ul class="tree-1">
                    <li><a href="<?php echo base_url(); ?>administrator/team/add"
                            data-i18n="nav.basic-components.alert">Add Team</a></li>
                    <li><a href="<?php echo base_url(); ?>administrator/team/list"
                            data-i18n="nav.basic-components.breadcrumbs">List Teams</a></li>
                </ul>
            </li>
            <li class="nav-item">
                <a href="#!">
                ...
                <ul class="tree-1" style="display: none;">
                    <li><a href="<?php echo base_url(); ?>administrator/testimonials/add"
                            data-i18n="nav.basic-components.alert">Add Testimonial</a></li>
                    <li><a href="<?php echo base_url(); ?>administrator/testimonials/list"
                            data-i18n="nav.basic-components.breadcrumbs">List Testimonials</a></li>
                </ul>
            </li>
        </ul>
    </div>
