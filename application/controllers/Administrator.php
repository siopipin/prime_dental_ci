...
class Administrator extends CI_Controller
{
    ...
    public function adminLogin()
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $user_id = $this->Administrator_Model->adminLogin(
                $email,
                $encrypt_password
            );
    ...
    public function create_product($page = 'add-product')
    {
        ...
        $this->form_validation->set_rules(
            'sku',
            'SKU',
            'required|callback_check_sku_exists'
        );
        ...
        if ($this->form_validation->run() === false) {
            ...
            if (!empty($_FILES['imgFiles']['name'])) {
                $multipleUpload = $this->multipleImageUpload(
                    $_FILES['imgFiles'],
                    $dataID
                );
            }
    ...
    public function multipleImageUpload($images, $dataID)
    {
        ...
        if (!empty($_FILES['imgFiles']['name'])) {
            ...
            if (!empty($uploadData)) {
                ...
                $insert = $this->Administrator_Model->insertproductsmultipleImages(
                    $uploadData
                );
                return $insert;
    ...
    public function check_sku_exists($sku)
    {
        $this->form_validation->set_message(
            'check_sku_exists',
            'That SKU is already taken, Please choose a different one.'
        );
    ...
    public function update_products($id = null)
    {
        ...
        $data['productImages'] = $this->Administrator_Model->product_images(
            $productId
        );
    ...
    public function update_products_data($page = 'update-product')
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $dataID = $this->Administrator_Model->update_products_data(
                $post_image
            );
            ...
            $this->session->set_flashdata(
                'success',
                'Product has been Updated Successfull.'
            );
            redirect('administrator/products');
        }
    }
    ...
    {
        $data['faqcategory'] = $this->Administrator_Model->update_faq_category(
            $id
        );
    ...
    public function create_faq($page = 'add-faq')
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $this->session->set_flashdata(
                'success',
                'FAQ has been Added Successfull.'
            );
    ...
    public function update_faqs_data($page = 'update-faqs')
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $this->session->set_flashdata(
                'success',
                'FAQ has been Updated Successfull.'
            );
            redirect('administrator/faqs');
        }
    }
    ...
    public function update_scopages_data($page = 'update-scopages')
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $this->session->set_flashdata(
                'success',
                'SCO Details has been Updated Successfull.'
            );
    ...
    {
        $data['sociallinks'] = $this->Administrator_Model->update_sociallinks(
            $id
        );
    ...
    public function update_sociallinks_data($page = 'update-sociallinks')
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $this->session->set_flashdata(
                'success',
                'sociallinks Details has been Updated Successfull.'
            );
    ...
    public function create_slider($page = 'add-slider')
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $this->session->set_flashdata(
                'success',
                'Slider Image has been created Successfull.'
            );
    ...
    public function update_slider_data($page = 'update-slider')
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $this->session->set_flashdata(
                'success',
                'Slider Images has been Updated Successfull.'
            );
            redirect('administrator/sliders');
        }
    }
    ...
    public function list_blog($offset = 0)
    {
        ...
        $data['blogs'] = $this->Administrator_Model->listblogs(
            false,
            $config['per_page'],
            $offset
        );
    ...
    public function update_blog($blog_id = false)
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            if (!$this->upload->do_upload()) {
                $errors = ['error' => $this->upload->display_errors()];
                $data['postimg'] = $this->Administrator_Model->listblogs(
                    $this->input->post('id')
                );
    ...
    public function update_siteconfiguration_data(
        $page = 'update-site-configuration'
    ) {
        if (!file_exists(APPPATH . 'views/administrator/' . $page . '.php')) {
            show_404();
        }
        ...
        if ($this->form_validation->run() === false) {
            ...
            $this->Administrator_Model->update_siteconfiguration_data(
                $post_image
            );
            //Set Message
            $this->session->set_flashdata(
                'success',
                'site configuration Details has been Updated Successfull.'
            );
    ...
    {
        $data['pagecontents'] = $this->Administrator_Model->update_pagecontents(
            $id
        );
    ...
    public function update_pagecontents_data($page = 'update-page-contents')
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $this->session->set_flashdata(
                'success',
                'Page Contents Details has been Updated Successfull.'
            );
    ...
    public function list_team($offset = 0)
    {
        ...
        $data['teams'] = $this->Administrator_Model->listteams(
            false,
            $config['per_page'],
            $offset
        );
    ...
    public function update_team($teamId)
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            if (!$this->upload->do_upload()) {
                $errors = ['error' => $this->upload->display_errors()];
                $data['teamimg'] = $this->Administrator_Model->listteams(
                    $this->input->post('id')
                );
    ...
    public function list_testimonial($offset = 0)
    {
        ...
        $data['testimonials'] = $this->Administrator_Model->listtestimonial(
            false,
            $config['per_page'],
            $offset
        );
    ...
    public function update_testimonial($id)
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            if (!$this->upload->do_upload()) {
                $errors = ['error' => $this->upload->display_errors()];
                $data['img'] = $this->Administrator_Model->listtestimonial(
                    $this->input->post('id')
                );
            ...
            $this->Administrator_Model->update_testimonial_data(
                $uploaded_image
            );
            //Set Message
            $this->session->set_flashdata(
    ...
    public function change_password($page = 'change-password')
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $this->Administrator_Model->change_password(
    ...
    public function forget_password_mail()
    {
        ...
        if ($this->Administrator_Model->email_exists()) {
            ...
            $message .=
                "<p><a href='" .
                base_url() .
                "administrator/reset-password/$temp_pass'>Click here </a>if you want to reset your password,
            ...
            if ($this->email->send()) {
                $this->load->model('Administrator_Model');
                if (
                    $this->Administrator_Model->temp_reset_password($temp_pass)
                ) {
